...
Note: This plugin only supports [Genesis child themes](http://www.studiopress.com/themes "Genesis child themes"). If you don't know what that is, don't download this plugin.
...
* [Demo](http://justintallant.com/genesis-bootstrap-carousel "Demo")
