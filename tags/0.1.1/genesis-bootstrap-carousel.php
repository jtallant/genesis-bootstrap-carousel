...
define( 'GENESIS_BOOTSTRAP_CAROUSEL_VERSION', '0.1.1' );
...
function genesis_bootstrap_carousel_deactivate() {
	...
	wp_die( 'Sorry, you cannot run Genesis Bootstrap Carousel without <a href="http://www.studiopress.com/themes/genesis">Genesis</a>' );
}
